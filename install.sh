...
while [ "$done" == false ]; do
  options=(
    ...
    "Install More Server Info (Only 1.7.0 and 1.8.1)"
    "Install Server Router Icons (Only 1.7.0 and 1.8.1)"
    "Install PMA Button NavBar (Only 1.7.0 and 1.8.1)"
    "Install PMA Button Database Tab (Only 1.7.0 and 1.8.1)"
